...
const compiledVendors = require('./compiledVendors')
...
module.exports = {
  ...
  module: {
    ...
    rules: [
      ...
      // Process SVGs with svg-sprite
      {
        test: /SvgSymbol\/svgs\/.*\.svg$/,
        use: [
          'svg-sprite-loader'
        ]
      },
  ...
  plugins: [
    ...
    new CopyWebpackPlugin([
      ...
      { from: require.resolve('workbox-google-analytics'), to: 'workbox-google-analytics.prod.js' },
      { from: require.resolve('localforage'), to: 'localforage.js' }
    ]),
    new WorkboxPlugin({
      globDirectory: `${paths.appBuild}/`,
      globPattern: ['**/*.{html,js,css,svg}'],
