...
class BookShelfWithViewport extends Component {
  render() {
    return <BookShelf viewport={this.props.viewport} {...this.props} />
  }
}

setAddon(JSXAddon);

const stories = storiesOf('BookShelf', module);
...
stories.addWithJSX('Default', () => {
  ...
  return <BookShelfWithViewport books={books}/>
});
